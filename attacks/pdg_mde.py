...
class PGDOpticalFlowMDEDAttack(OpticalFlowAttack):
    ...
    def attack(self, inputs: Dict[str, torch.Tensor]):
        ...
        mde_pred_orig = self.mde_model(orig_inputs)
        ...
        mde_target = self.mde_target(mde_pred_orig)
