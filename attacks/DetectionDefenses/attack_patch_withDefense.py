...
def train_patch(args):
    ...
    with mlflow.start_run(experiment_id=experiment_id, run_name=folder_name) as run:
        ...
        log_param('random_looc', args.random_loc)
        ...
        # adversary
        A = PatchAdversary(None,size=args.patch_size,angle=[-10,10],scale=[0.95,1.05], change_of_variable=args.change_of_variables, random_location=args.random_loc).to(device)
