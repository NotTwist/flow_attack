...
from .config_specs import Paths
...
class Test(FlowDataset):
    def __init__(self, aug_params=None, split='eval', root=Paths.config("test"), has_gt=False):
        super(Test, self).__init__(aug_params)
        ...
        self.enforce_dimensions = True
        self.image_x_dim = 338
        self.image_y_dim = 600
