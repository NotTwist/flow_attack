...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root=Paths.config("sintel_mpi"), dstype='clean', has_gt=False, frames=2):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root=Paths.config("kitti15"), has_gt=False, frames=2):
...
class Demo(FlowDataset):
    def __init__(self, aug_params=None, split='eval', root=Paths.config("test"), has_gt=False, n_images=-1, frames=2):
